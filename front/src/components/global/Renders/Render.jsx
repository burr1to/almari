...
import Mugg from "./statics/mug.gltf";
...
function Mug(props) {
  ...
  const { nodes, materials } = useGLTF(Mugg);
  ...
  return (
    ...
    >
      ...
      />
      <mesh
        material-color={snap.items.Top_Band}
        geometry={nodes.Top_Band.geometry}
        material={materials.Top_Band}
        scale={[15, 15, 15]}
      />
      <mesh
        material-color={snap.items.Bot_Band}
        geometry={nodes.Bot_Band.geometry}
        material={materials.Bot_Band}
        scale={[15, 15, 15]}
      />
      <mesh
        material-color={snap.items.Mid_Band}
        geometry={nodes.Mid_Band.geometry}
        material={materials.Mid_Band}
        scale={[15, 15, 15]}
      />
      <mesh
